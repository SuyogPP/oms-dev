...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-6 rounded-2xl border shadow-sm transition-all duration-300 ease-out hover:shadow-md hover:-translate-y-[1px]",
        className,
      )}
      {...props}
    />
